...
const tabsListVariants = cva(
  "group/tabs-list inline-flex h-10 w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
