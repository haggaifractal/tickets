    ...
    <div className="container mx-auto p-6 max-w-6xl space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-lg mt-2">Overview of team performance and billing administration.</p>
        </div>
      </div>

      <Tabs defaultValue="stats" className="w-full">
        <TabsList className="grid w-full grid-cols-2 max-w-[400px]">
          <TabsTrigger value="stats">Technician Stats</TabsTrigger>
          <TabsTrigger value="billing">Pending Billing</TabsTrigger>
        </TabsList>
